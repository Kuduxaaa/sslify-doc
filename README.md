...
##  9. არქიტექტურის დეტალური აღწერა

წინამდებარე სექცია დეტალურად აღწერს სისტემის არქიტექტურას, კომპონენტების ურთიერთკავშირს და მონაცემთა ნაკადების ლოგიკას, როგორც ეს ვიზუალურ დიაგრამაზეა წარმოდგენილი. სისტემა დაპროექტებულია მაღალი ხელმისაწვდომობის (High Availability), უსაფრთხოებისა და პროცესების მაქსიმალური ავტომატიზაციის პრინციპებით.

### 9.1. მომხმარებლის მოთხოვნის სასიცოცხლო ციკლი (End-to-End Traffic Flow)

აღწერილია სრული გზა, რომელსაც მომხმარებლის მოთხოვნა გადის ინფრასტრუქტურაში.

   1. **DNS რეზოლუცია**: მომხმარებლის მიერ დომენის მისამართის ბრაუზერში აკრეფისას, მოთხოვნა იგზავნება სისტემის **DNS კლასტერთან** (`ns1.csg.ge`, `ns2.csg.ge`). DNS სერვერები საპასუხოდ აბრუნებენ არა კონკრეტული სერვერის, არამედ **Load Balancer კლასტერის** საერთო ვირტუალურ IP მისამართს (Public VIP), რომელიც სისტემის ერთიანი შესასვლელი წერტილია.

   2. **Load Balancer კლასტერი**: ტრაფიკი ხვდება ვირტუალურ IP-ზე. `Keepalived` სერვისი უზრუნველყოფს, რომ მოთხოვნა დამუშავდეს კლასტერის იმ მომენტისთვის აქტიური (MASTER) წევრის მიერ. რომელიმე ბალანსერის გათიშვის შემთხვევაში, `Keepalived` მომენტალურად გადაამისამართებს მთელ ტრაფიკს სარეზერვო (BACKUP) ბალანსერზე, რაც სერვისის უწყვეტობას უზრუნველყოფს.

   3. **WAF პროქსი კლასტერი**: აქტიური Load Balancer-ის HAProxy სერვისი იღებს HTTP/S მოთხოვნას და გადაამისამართებს მას WAF Proxy კლასტერის ერთ-ერთ ხელმისაწვდომ სერვერზე. ეს პროცესი უზრუნველყოფს როგორც დატვირთვის განაწილებას, ასევე სისტემის მდგრადობას WAF სერვერის გაუმართაობის შემთხვევაში.

   4. **ანალიზი და უსაფრთხოების წესების მოთხოვნა**: WAF სერვერი იწყებს შემოსული ტრაფიკის ანალიზს. ანალიზისთვის მას სჭირდება უსაფრთხოების წესების აქტუალური სია, რომელსაც ის მონაცემთა ბაზების კლასტერიდან იღებს. ეს პროცესი მიმდინარეობს შემდეგნაირად:

      - WAF სერვერი აყალიბებს მოთხოვნას ბაზის მიმართულებით.
      - მოთხოვნა იგზავნება Load Balancer-ის კლასტერთან, MySQL-ის სტანდარტულ პორტზე (3306).
      - `HAProxy` იღებს ამ მოთხოვნას და გადაამისამართებს მას აქტიურ მონაცემთა ბაზის სერვერზე.
     
   5. **ვერდიქტი**: ბაზიდან წესების მიღების შემდეგ, WAF-ი სრულად აანალიზებს მომხმარებლის თავდაპირველ მოთხოვნას და იღებს გადაწყვეტილებას:
      - **ALLOW (გატარება)**: თუ მოთხოვნა ლეგიტიმურია, ის დაიშვება და გადაიგზავნება კლიენტის საბოლოო ვებ-სერვერისკენ.
      - **BLOCK (დაბლოკვა)**: თუ მოთხოვნა შეიცავს საშიშ კოდს ან არღვევს უსაფრთხოების წესებს, ის დაიბლოკება და დანიშნულების ადგილამდე ვერ მიაღწევს.

### 9.2. შიდა პროცესები და ავტომატიზაცია

მომხმარებლის ტრაფიკის დამუშავების პარალელურად, სისტემაში მიმდინარეობს რამდენიმე მნიშვნელოვანი ფონური პროცესი.

   - **SSL სერტიფიკატების ავტომატური განახლება**: მთავარ DNS სერვერზე კონფიგურირებულია Cron Job, რომელიც პერიოდულად უშვებს certbot-ის სკრიპტს. certbot ავტომატურად უკავშირდება Let's Encrypt-ს, ამტკიცებს დომენის ფლობას (DNS-01 Challenge მეთოდით) და იღებს განახლებულ SSL სერტიფიკატებს. შემდგომ, მიღებული .pem ფაილები უსაფრთხოდ იგზავნება (scp) ორივე Load Balancer სერვერზე, რაც უზრუნველყოფს სერტიფიკატების მუდმივ ვალიდურობას ადამიანის ჩარევის გარეშე.

   - **სისტემის მართვა და მონაცემთა სინქრონიზაცია**: ადმინისტრატორებს შეუძლიათ სისტემის მართვა WAF Control Panel-ის მეშვეობით. პანელში განხორციელებული ნებისმიერი ცვლილება (მაგ. ახალი წესის დამატება) აისახება მონაცემთა ბაზების კლასტერში. კლასტერი მუშაობს Master-Master რეპლიკაციის რეჟიმში, რაც ნიშნავს, რომ ორივე ბაზის სერვერი აქტიურია და მათ შორის მონაცემები მუდმივად სინქრონიზდება. ეს სტრუქტურა უზრუნველყოფს მონაცემთა ბაზის მაღალ ხელმისაწვდომობას და ინფორმაციის დაკარგვისგან დაცვას.
